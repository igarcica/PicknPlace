...
(:init (garment_at towel grws) (at_pose towel singledge) (garment_state towel notgrasped) (not (corners_pos_known towel)) 
		(not (known_obj hola))
		...
		(= (place_succ hola singledge placevert) 0)
		(= (place_succ hola multedges placevert) 1)
		(= (place_succ hola singledge placediag) 5000)
		(= (place_succ hola multedges placediag) 3)
)

(:goal (and (garment_state towel grasped)))
