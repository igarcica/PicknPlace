...
Metric is ((5.00*[RF1](TIME_COST)10.00*[RF0](PLACE_QUAL)) - () + 0.00)
...
step    0: PLACEVERT HOLA TOWEL LONG A
plan cost: 50.000000

time spent:    0.00 seconds instantiating 119 easy, 18 hard action templates
               0.00 seconds reachability analysis, yielding 20 facts and 9 actions
               0.00 seconds creating final representation with 8 relevant facts, 2 relevant fluents
