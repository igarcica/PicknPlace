...
;;(:init (garment_state towel placed) (defstate towel2 flat) (at_pose towel short)
		...
		(= (place_succ towel B placevert) 3)
		(= (place_succ towel B placediag) 0)
		(= (place_succ towel B placerot) 5)
		(= (place_succ towel C placevert) 22)
		(= (place_succ towel C placediag) 22)
		(= (place_succ towel C placerot) 6)
		;;piling costs
		(= (place_succ towel2 A placevert) 0)
		(= (place_succ towel2 B placevert) 22)
		(= (place_succ towel2 B placediag) 15)
		(= (place_succ towel2 B placerot) 10)
		(= (place_succ towel2 C placevert) 22)
		(= (place_succ towel2 C placediag) 22)
		(= (place_succ towel2 C placerot) 22)
