...
(:init (garment_state table placed) (robot_at else) (robot_empty)
		...
		(known_obj towel) (garment_state towel notgrasped) (garment_at towel rotws) (at_pose towel long) (not (corners_pos_known towel)) (defstate towel flat) 
		...
		(obj_grasp_class towel long A)  ;; towel grasped by long edge results in deformation class A
...
(:goal (and (on towel table) (on checkered1 towel) (on checkered2 checkered1) (on waffle1 checkered2) (on waffle2 waffle1)
))
